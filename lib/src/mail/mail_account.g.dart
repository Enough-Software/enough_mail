...
MailAccount _$MailAccountFromJson(Map<String, dynamic> json) => MailAccount(
  ...
  incoming: MailServerConfig.fromJson(json['incoming'] as Map<String, dynamic>),
  outgoing: MailServerConfig.fromJson(json['outgoing'] as Map<String, dynamic>),
  userName: json['userName'] as String? ?? '',
  outgoingClientDomain: json['outgoingClientDomain'] as String? ?? 'enough.de',
...
MailServerConfig _$MailServerConfigFromJson(Map<String, dynamic> json) =>
    MailServerConfig(
      ...
      serverCapabilities:
          (json['serverCapabilities'] as List<dynamic>?)
